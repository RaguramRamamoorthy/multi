...
def write(df):
    ...
    a.markdown("*Note - If you want to explore the animation using other features \ wait until the initial animation "
               "has ended or skip through to the end before changing features otherwise you may \ see some odd "
               "behaviour in the animation. Plotly can be a little fickle like that*")
